...
import com.HuskyGroups.auth.UserDetailsImpl;
import com.HuskyGroups.database.RoleRepository;
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        if (userRepository.existsByEmail(signUpRequest.getEmail())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Error: Email is already existed in our database!"));
        }
